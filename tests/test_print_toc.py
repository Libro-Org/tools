...
def test_print_toc(data_dir: Path, draft_dir: Path, work_dir: Path, update_golden: bool, capfd):
	...
	must_run(f"libro print-toc {book_dir}")
...
def test_add_landmark_no_title():
	...
	dom = se.easy_xml.EasyXhtmlTree('<?xml version="1.0" encoding="utf-8"?>\n<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" epub:prefix="z3998: http://www.daisy.org/z3998/2012/vocab/structure/, se: https://standardebooks.org/vocab/1.0" xml:lang="es-ES"><body><section epub:type="foo"><h1></h1></section></body></html>')
	landmarks = []
...
def test_add_landmark_with_title():
	...
	dom = se.easy_xml.EasyXhtmlTree('<?xml version="1.0" encoding="utf-8"?>\n<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" epub:prefix="z3998: http://www.daisy.org/z3998/2012/vocab/structure/, se: https://standardebooks.org/vocab/1.0" xml:lang="es-ES"><head><title>Bar</title></head><body><section epub:type="foo"><h1></h1></section></body></html>')
	landmarks = []
	add_landmark(dom, "file", landmarks)
...
def test_add_landmark_empty_title():
	...
	dom = se.easy_xml.EasyXhtmlTree('<?xml version="1.0" encoding="utf-8"?>\n<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops" epub:prefix="z3998: http://www.daisy.org/z3998/2012/vocab/structure/, se: https://standardebooks.org/vocab/1.0" xml:lang="es-ES"><head><title></title></head><body><section epub:type="foo"><h1></h1></section></body></html>')
	landmarks = []
	add_landmark(dom, "file", landmarks)
